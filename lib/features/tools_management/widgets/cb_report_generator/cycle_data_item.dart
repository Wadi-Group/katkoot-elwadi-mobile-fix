...
class CbCycleDataItem extends StatefulWidget {
  final String? title, value;

  CbCycleDataItem({required this.title, required this.value});

  @override
  State<CbCycleDataItem> createState() => _CycleDataItemState();
}

class _CycleDataItemState extends State<CbCycleDataItem> {
  @override

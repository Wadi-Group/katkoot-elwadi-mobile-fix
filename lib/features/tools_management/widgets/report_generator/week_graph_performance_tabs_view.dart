...
class WeekGraphPerformanceTabsView extends StatefulWidget {
  final Function onCh1TabTap;
  final Function onCh2TabTap;
  final Function onCh3TabTap;
  final Function onCh4TabTap;

  WeekGraphPerformanceTabsView({
    required this.onCh1TabTap,
    required this.onCh2TabTap,
    required this.onCh3TabTap,
    required this.onCh4TabTap,
  });

  @override
  State<WeekGraphPerformanceTabsView> createState() =>
      _WeekGraphPerformanceTabsViewState();
}

class _WeekGraphPerformanceTabsViewState
    extends State<WeekGraphPerformanceTabsView> {

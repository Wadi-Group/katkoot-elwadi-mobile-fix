...
class CycleWeekDataItem extends StatefulWidget {
  ...
  @override
  State<CycleWeekDataItem> createState() => _CycleWeekDataItemState();
}

class _CycleWeekDataItemState extends State<CycleWeekDataItem> {
  @override

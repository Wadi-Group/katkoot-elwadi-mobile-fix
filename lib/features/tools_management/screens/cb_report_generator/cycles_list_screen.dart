...
class CbCyclesScreen extends StatefulWidget {
  static const routeName = "./CbCyclesScreen";

  final Category category;
  final Tool tool;

  CbCyclesScreen({required this.category, required this.tool});

  @override
  _CbCyclesScreenState createState() => _CbCyclesScreenState();
}

class _CbCyclesScreenState extends State<CbCyclesScreen>

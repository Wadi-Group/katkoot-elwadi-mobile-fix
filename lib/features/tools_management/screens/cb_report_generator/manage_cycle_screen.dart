...
import 'package:katkoot_elwady/features/tools_management/screens/cb_report_generator/add_production_week_data_screen.dart';
import 'package:katkoot_elwady/features/tools_management/screens/cb_report_generator/add_rearing_week_data_screen.dart';
...
import 'package:katkoot_elwady/features/tools_management/view_models/cb_report_generator/manage_cycle_view_model.dart';
import 'package:katkoot_elwady/features/tools_management/widgets/cb_report_generator/week_row_item.dart';
...
class _ManageCycleScreenState extends State<ManageCycleScreen>
  ...
  @override
  void initState() {
    selectedWeek = widget.cycle.getCbMaxWeek();
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            if (!widget.cycle.weekCbIsExists(selectedWeek))
                              buildAddDataBtn(),
                            SizedBox(
                              height: 20,
                            ),
                  ...
                  child: Container(
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) => Container(
                            color: AppColors.white,
                            child: WeekRowItem(
                              hasData: widget.cycle.weekCbIsExists(index + 1),
                              week: weeks[index],
                              onTap: () {
                                setState(() {
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  CustomText(
                    title: widget.cycle.getCbLevel(selectedWeek),

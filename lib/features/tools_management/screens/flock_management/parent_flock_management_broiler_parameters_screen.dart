...
class ParentFlockManagementBroilerParametersScreenData {
  final StateNotifierProvider<ParentFlockManagementBroilerViewModel,
      BaseState<ParentFlockManagementBroilerState>> screenProvider;
  final Defaults? defaults;

  ParentFlockManagementBroilerParametersScreenData(
      {required this.screenProvider, required this.defaults});
}

class ParentFlockManagementBroilerParametersScreen extends StatefulWidget {
  static const routeName = "./parent_flock_management_broiler_parameters";

  final StateNotifierProvider<ParentFlockManagementBroilerViewModel,
      BaseState<ParentFlockManagementBroilerState>> screenProvider;
  final Defaults? defaults;

  const ParentFlockManagementBroilerParametersScreen(
      {Key? key, required this.screenProvider, required this.defaults})
      : super(key: key);

  @override
  _ParentFlockManagementBroilerParametersScreenState createState() =>
      _ParentFlockManagementBroilerParametersScreenState();
}

class _ParentFlockManagementBroilerParametersScreenState
    extends State<ParentFlockManagementBroilerParametersScreen> {
    ...
    return Scaffold(
      ...
      children: [
        ParentFlockManagementParametersHeaderView(
          onEraseAllClick: () => ProviderScope.containerOf(context,

...
class ParentStockFlockRequirementScreen extends StatefulWidget {
  ...
  ParentStockFlockRequirementScreen({required this.category, this.toolId});

  @override
  _ParentStockFlockRequirementScreenState createState() =>
      _ParentStockFlockRequirementScreenState();
}

class _ParentStockFlockRequirementScreenState
    extends State<ParentStockFlockRequirementScreen> with SliderMixin {
  late final _selectedAgeIndexProvider = Provider<int?>((ref) {
